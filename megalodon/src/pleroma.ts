...
export default class Pleroma implements MegalodonInterface {
	...
	public async registerAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Token>("/api/v1/accounts", params)
			.then((res) => {
	...
	public async verifyAccountCredentials(): Promise<Response<Entity.Account>> {
		return this.client
			.get<PleromaAPI.Entity.Account>("/api/v1/accounts/verify_credentials")
			.then((res) => {
				return Object.assign(res, {
	...
	public async updateCredentials(options?: {
		...
		return this.client
			.patch<PleromaAPI.Entity.Account>(
	...
	public async getAccount(id: string): Promise<Response<Entity.Account>> {
		return this.client
			.get<PleromaAPI.Entity.Account>(`/api/v1/accounts/${id}`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.account(res.data),
				});
   ...
   */
	public async getAccountStatuses(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Status>>(
	...
	public async subscribeAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Relationship>(
	...
	public async getAccountFollowers(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Account>>(
	...
	public async getAccountFollowing(
		...
		return this.client
			.get<Array<MastodonEntity.Account>>(
	...
	public async getAccountLists(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.List>>(`/api/v1/accounts/${id}/lists`)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getIdentityProof(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.IdentityProof>>(
	...
	public async unfollowAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unfollow`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.relationship(res.data),
				});
	...
	public async blockAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Relationship>(`/api/v1/accounts/${id}/block`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.relationship(res.data),
				});
	...
	public async unblockAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unblock`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.relationship(res.data),
				});
	...
	public async unmuteAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unmute`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.relationship(res.data),
				});
	...
	public async pinAccount(id: string): Promise<Response<Entity.Relationship>> {
		return this.client
			.post<PleromaAPI.Entity.Relationship>(`/api/v1/accounts/${id}/pin`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.relationship(res.data),
				});
	...
	public async unpinAccount(
		...
		return this.client
			.post<PleromaAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unpin`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.relationship(res.data),
				});
	...
	public async getRelationship(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Relationship>>(
	...
	public async searchAccount(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Account>>("/api/v1/accounts/search", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((a) => PleromaAPI.Converter.account(a)),
				});
	...
	public async getBookmarks(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Status>>("/api/v1/bookmarks", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((s) => PleromaAPI.Converter.status(s)),
				});
	...
	public async getFavourites(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Status>>("/api/v1/favourites", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((s) => PleromaAPI.Converter.status(s)),
				});
	...
	public async getMutes(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Account>>("/api/v1/mutes", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((a) => PleromaAPI.Converter.account(a)),
				});
	...
	public async getBlocks(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Account>>("/api/v1/blocks", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((a) => PleromaAPI.Converter.account(a)),
				});
	...
	public async getFilters(): Promise<Response<Array<Entity.Filter>>> {
		return this.client
			.get<Array<PleromaAPI.Entity.Filter>>("/api/v1/filters")
			.then((res) => {
				return Object.assign(res, {
	...
	public async getFilter(id: string): Promise<Response<Entity.Filter>> {
		return this.client
			.get<PleromaAPI.Entity.Filter>(`/api/v1/filters/${id}`)
			.then((res) => {
				return Object.assign(res, {
	...
	public async createFilter(
		...
		return this.client
			.post<PleromaAPI.Entity.Filter>("/api/v1/filters", params)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.filter(res.data),
				});
	...
	public async updateFilter(
		...
		return this.client
			.put<PleromaAPI.Entity.Filter>(`/api/v1/filters/${id}`, params)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.filter(res.data),
				});
	...
	public async deleteFilter(id: string): Promise<Response<Entity.Filter>> {
		return this.client
			.del<PleromaAPI.Entity.Filter>(`/api/v1/filters/${id}`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.filter(res.data),
				});
	...
	public async report(
		...
		return this.client
			.post<PleromaAPI.Entity.Report>("/api/v1/reports", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getEndorsements(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Account>>("/api/v1/endorsements", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((a) => PleromaAPI.Converter.account(a)),
				});
	...
	public async getFeaturedTags(): Promise<Response<Array<Entity.FeaturedTag>>> {
		return this.client
			.get<Array<PleromaAPI.Entity.FeaturedTag>>("/api/v1/featured_tags")
			.then((res) => {
				return Object.assign(res, {
	...
	public async getSuggestedTags(): Promise<Response<Array<Entity.Tag>>> {
		return this.client
			.get<Array<PleromaAPI.Entity.Tag>>("/api/v1/featured_tags/suggestions")
			.then((res) => {
				return Object.assign(res, {
	...
	public async getPreferences(): Promise<Response<Entity.Preferences>> {
		return this.client
			.get<PleromaAPI.Entity.Preferences>("/api/v1/preferences")
			.then((res) => {
				return Object.assign(res, {
	...
	public async postStatus(
		...
		if (options?.scheduled_at) {
			return this.client
				.post<PleromaAPI.Entity.ScheduledStatus>("/api/v1/statuses", params)
				.then((res) => {
					return Object.assign(res, {
		...
		return this.client
			.post<PleromaAPI.Entity.Status>("/api/v1/statuses", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.get<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
   ...
   */
	public async editStatus(
		...
		return this.client
			.put<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}`, params)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async deleteStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.del<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async getStatusContext(
		...
		return this.client
			.get<PleromaAPI.Entity.Context>(`/api/v1/statuses/${id}/context`, params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getStatusSource(
		...
		return this.client
			.get<PleromaAPI.Entity.StatusSource>(`/api/v1/statuses/${id}/source`)
			.then((res) => {
				return Object.assign(res, {
	...
	public async favouriteStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/favourite`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async unfavouriteStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/unfavourite`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async reblogStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/reblog`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async unreblogStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/unreblog`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async bookmarkStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/bookmark`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async unbookmarkStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/unbookmark`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async muteStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/mute`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async unmuteStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/unmute`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async pinStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/pin`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async unpinStatus(id: string): Promise<Response<Entity.Status>> {
		return this.client
			.post<PleromaAPI.Entity.Status>(`/api/v1/statuses/${id}/unpin`)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
				});
	...
	public async uploadMedia(
		...
		return this.client
			.postForm<PleromaAPI.Entity.AsyncAttachment>("/api/v2/media", formData)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getMedia(id: string): Promise<Response<Entity.Attachment>> {
		const res = await this.client.get<PleromaAPI.Entity.Attachment>(
			`/api/v1/media/${id}`,
		);
	...
	public async updateMedia(
		...
		return this.client
			.putForm<PleromaAPI.Entity.Attachment>(`/api/v1/media/${id}`, formData)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.attachment(res.data),
				});
	...
	public async getPoll(id: string): Promise<Response<Entity.Poll>> {
		return this.client
			.get<PleromaAPI.Entity.Poll>(`/api/v1/polls/${id}`)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getScheduledStatuses(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.ScheduledStatus>>(
	...
	public async getScheduledStatus(
		...
		return this.client
			.get<PleromaAPI.Entity.ScheduledStatus>(
	...
	public async scheduleStatus(
		...
		return this.client
			.put<PleromaAPI.Entity.ScheduledStatus>(
				`/api/v1/scheduled_statuses/${id}`,
				params,
			)
			.then((res) => {
	...
	public async getPublicTimeline(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Status>>("/api/v1/timelines/public", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((s) => PleromaAPI.Converter.status(s)),
				});
	...
	public async getHomeTimeline(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Status>>("/api/v1/timelines/home", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((s) => PleromaAPI.Converter.status(s)),
				});
	...
	public async getConversationTimeline(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Conversation>>(
	...
	public async readConversation(
		...
		return this.client
			.post<PleromaAPI.Entity.Conversation>(`/api/v1/conversations/${id}/read`)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getLists(): Promise<Response<Array<Entity.List>>> {
		return this.client
			.get<Array<PleromaAPI.Entity.List>>("/api/v1/lists")
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((l) => PleromaAPI.Converter.list(l)),
				});
	...
	public async getList(id: string): Promise<Response<Entity.List>> {
		return this.client
			.get<PleromaAPI.Entity.List>(`/api/v1/lists/${id}`)
			.then((res) => {
				return Object.assign(res, {
	...
	public async saveMarkers(options?: {
		...
		return this.client
			.post<PleromaAPI.Entity.Marker>("/api/v1/markers", params)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.marker(res.data),
				});
	...
	public async getNotifications(options?: {
			...
			if (options.exclude_types) {
				params = Object.assign(params, {
					exclude_types: options.exclude_types.map((e) =>
						PleromaAPI.Converter.encodeNotificationType(e),
					),
				});
			}
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Notification>>(
	...
	public async getNotification(
		...
		const res = await this.client.get<PleromaAPI.Entity.Notification>(
	...
	public async readNotifications(options: {
		...
		if (options.id) {
			const res = await this.client.post<PleromaAPI.Entity.Notification>(
			...
			const res = await this.client.post<Array<PleromaAPI.Entity.Notification>>(
				"/api/v1/pleroma/notifications/read",
				{
					max_id: options.max_id,
				},
	...
	public async subscribePushNotification(
		...
		return this.client
			.post<PleromaAPI.Entity.PushSubscription>(
	...
	> {
		return this.client
			.get<PleromaAPI.Entity.PushSubscription>("/api/v1/push/subscription")
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.push_subscription(res.data),
				});
	...
	public async updatePushSubscription(
		...
		return this.client
			.put<PleromaAPI.Entity.PushSubscription>(
				"/api/v1/push/subscription",
				params,
			)
			.then((res) => {
	...
	public async search(
		...
		return this.client
			.get<PleromaAPI.Entity.Results>("/api/v2/search", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getInstance(): Promise<Response<Entity.Instance>> {
		return this.client
			.get<PleromaAPI.Entity.Instance>("/api/v1/instance")
			.then((res) => {
				return Object.assign(res, {
	...
	> {
		return this.client
			.get<Array<PleromaAPI.Entity.Activity>>("/api/v1/instance/activity")
			.then((res) => {
				return Object.assign(res, {
	...
	public async getInstanceTrends(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Tag>>("/api/v1/trends", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((t) => PleromaAPI.Converter.tag(t)),
				});
	...
	public async getInstanceDirectory(options?: {
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Account>>("/api/v1/directory", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((a) => PleromaAPI.Converter.account(a)),
				});
	...
	> {
		return this.client
			.get<Array<PleromaAPI.Entity.Emoji>>("/api/v1/custom_emojis")
			.then((res) => {
				return Object.assign(res, {
	...
	> {
		return this.client
			.get<Array<PleromaAPI.Entity.Announcement>>("/api/v1/announcements")
			.then((res) => {
				return Object.assign(res, {
	...
	public async createEmojiReaction(
		...
		return this.client
			.put<PleromaAPI.Entity.Status>(
				`/api/v1/pleroma/statuses/${id}/reactions/${encodeURI(emoji)}`,
			)
			.then((res) => {
				return Object.assign(res, {
					data: PleromaAPI.Converter.status(res.data),
	...
	public async getEmojiReactions(
		...
		return this.client
			.get<Array<PleromaAPI.Entity.Reaction>>(
	...
	public async getEmojiReaction(
		...
		return this.client
			.get<PleromaAPI.Entity.Reaction>(
				`/api/v1/pleroma/statuses/${id}/reactions/${encodeURI(emoji)}`,
			)
			.then((res) => {
				return Object.assign(res, {
