...
import * as custom_emoji from './entities/customEmoji.js'
...
export namespace Entity {
  ...
  export type CustomEmoji = custom_emoji.CustomEmoji
  export type CustomEmojiResponse = custom_emoji.CustomEmojiResponse
