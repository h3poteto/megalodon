...
import SharkeyAPI from './sharkey/api_client.js'
import { DEFAULT_UA } from './default.js'
import OAuth from './oauth.js'
import * as SharkeyOAuth from './sharkey/oauth.js'
...
export default class Sharkey implements MegalodonInterface {
  public client: SharkeyAPI.Interface
  ...
  constructor(baseUrl: string, accessToken: string | null = null, userAgent: string | null = DEFAULT_UA, axiosInstance?: AxiosInstance) {
    ...
    this.client = new SharkeyAPI.Client(baseUrl, token, agent, axiosInstance)
  ...
  public async registerApp(
    ...
    options: Partial<{ scopes: Array<string>; redirect_uris: string; website: string }> = {
      scopes: SharkeyAPI.DEFAULT_SCOPE,
  ...
  public async createApp(
    ...
    const scopes = options.scopes || SharkeyAPI.DEFAULT_SCOPE
    ...
    */
    return this.client.post<SharkeyOAuth.AppDataFromServer>('/api/app/create', params).then((res: Response<SharkeyAPI.Entity.App>) => {
      return SharkeyOAuth.toAppData(res.data)
    })
  }
   ...
   */
  public async generateAuthUrlAndToken(clientSecret: string): Promise<SharkeyAPI.Entity.Session> {
    return this.client
      .post<SharkeyAPI.Entity.Session>('/api/auth/session/generate', {
        appSecret: clientSecret
      })
      .then((res: Response<SharkeyAPI.Entity.Session>) => res.data)
  }
  ...
  public async fetchAccessToken(
    ...
    return this.client
      .post<SharkeyOAuth.TokenDataFromServer>('/api/auth/session/userkey', {
        appSecret: client_secret,
        token: session_token
      })
      .then(res => {
        return SharkeyOAuth.toTokenData(res.data)
      })
  }
  ...
  public async verifyAccountCredentials(): Promise<Response<Entity.Account>> {
    return this.client.post<SharkeyAPI.Entity.UserDetail>('/api/i').then(res => {
      return Object.assign(res, {
        data: SharkeyAPI.Converter.userDetail(res.data)
      })
    })
  }
  ...
  public async updateCredentials(options?: {
    ...
    return this.client.post<SharkeyAPI.Entity.UserDetail>('/api/i', params).then(res => {
      return Object.assign(res, {
        data: SharkeyAPI.Converter.userDetail(res.data)
      })
    })
  ...
  public async getAccount(id: string): Promise<Response<Entity.Account>> {
    return this.client
      .post<SharkeyAPI.Entity.UserDetail>('/api/users/show', {
        userId: id
      })
      .then(res => {
        return Object.assign(res, {
  ...
  public async getAccountStatuses(
      ...
      return this.client
        ...
        .then(res => {
          if (res.data.pinnedNotes) {
            return { ...res, data: res.data.pinnedNotes.map(n => SharkeyAPI.Converter.note(n)) }
          }
          return { ...res, data: [] }
        })
    }
    ...
    return this.client.post<Array<SharkeyAPI.Entity.Note>>('/api/users/notes', params).then(res => {
      const statuses: Array<Entity.Status> = res.data.map(note => SharkeyAPI.Converter.note(note))
      return Object.assign(res, {
        data: statuses
      })
    })
  ...
  public async getAccountFollowers(
    ...
    return this.client.post<Array<SharkeyAPI.Entity.Follow>>('/api/users/followers', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(f => SharkeyAPI.Converter.follower(f))
      })
    })
  }
  ...
  public async getAccountFollowing(
    ...
    return this.client.post<Array<SharkeyAPI.Entity.Follow>>('/api/users/following', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(f => SharkeyAPI.Converter.following(f))
      })
    })
  }
  ...
  public async followAccount(id: string, _options?: { reblog?: boolean }): Promise<Response<Entity.Relationship>> {
    ...
    return this.client
      .post<SharkeyAPI.Entity.Relation>('/api/users/relation', {
        userId: id
      })
      .then(res => {
        return Object.assign(res, {
          data: SharkeyAPI.Converter.relation(res.data)
        })
      })
  }
  ...
  public async getRelationship(id: string): Promise<Response<Entity.Relationship>> {
    return this.client
      .post<Array<SharkeyAPI.Entity.Relation>>('/api/users/relation', {
        userId: [id]
      })
      .then(res => {
        return Object.assign(res, {
          data: SharkeyAPI.Converter.relation(res.data[0])
        })
      })
  }
  ...
  public async getRelationships(ids: Array<string>): Promise<Response<Array<Entity.Relationship>>> {
    return this.client
      ...
      .then(res => {
        return Object.assign(res, {
          data: res.data.map(r => SharkeyAPI.Converter.relation(r))
        })
      })
  }
  ...
  public async searchAccount(
    ...
    return this.client.post<Array<SharkeyAPI.Entity.UserDetail>>('/api/users/search', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(u => SharkeyAPI.Converter.userDetail(u))
      })
    })
  }
  ...
  public async getFavourites(options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>> {
    ...
    return this.client.post<Array<SharkeyAPI.Entity.Favorite>>('/api/i/favorites', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(fav => SharkeyAPI.Converter.note(fav.note))
      })
    })
  }
  ...
  public async getMutes(options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<Entity.Account>>> {
    ...
    return this.client.post<Array<SharkeyAPI.Entity.Mute>>('/api/mute/list', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(mute => SharkeyAPI.Converter.userDetail(mute.mutee))
      })
    })
  }
  ...
  public async getBlocks(options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<Entity.Account>>> {
    ...
    return this.client.post<Array<SharkeyAPI.Entity.Blocking>>('/api/blocking/list', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(blocking => SharkeyAPI.Converter.userDetail(blocking.blockee))
      })
    })
  }
  ...
  public async getFollowRequests(_limit?: number): Promise<Response<Array<Entity.Account>>> {
    return this.client.post<Array<SharkeyAPI.Entity.FollowRequest>>('/api/following/requests/list').then(res => {
      return Object.assign(res, {
        data: res.data.map(r => SharkeyAPI.Converter.user(r.follower))
      })
    })
  }
  ...
  public async getPreferences(): Promise<Response<Entity.Preferences>> {
    return this.client.post<SharkeyAPI.Entity.UserDetailMe>('/api/i').then(async res => {
      return Object.assign(res, {
        data: SharkeyAPI.Converter.userPreferences(res.data, await this.getDefaultPostPrivacy())
      })
    })
  }
  ...
  private async getDefaultPostPrivacy(): Promise<Entity.StatusVisibility> {
    return this.client
      ...
      .then(res => {
        ...
        return SharkeyAPI.Converter.visibility(res.data)
      })
      .catch(_ => 'public')
  }
  ...
  public async getSuggestions(limit?: number): Promise<Response<Array<Entity.Account>>> {
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.UserDetail>>('/api/users/recommendation', params)
      .then(res => ({ ...res, data: res.data.map(u => SharkeyAPI.Converter.userDetail(u)) }))
  }
  ...
  public async postStatus(
    ...
    if (options) {
      ...
      if (options.visibility) {
        params = Object.assign(params, {
          visibility: SharkeyAPI.Converter.encodeVisibility(options.visibility)
        })
      }
      if (options.quote_id) {
        params = Object.assign(params, {
    ...
    return this.client
      .post<SharkeyAPI.Entity.CreatedNote>('/api/notes/create', params)
      .then(res => ({ ...res, data: SharkeyAPI.Converter.note(res.data.createdNote) }))
  }
  ...
  public async getStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client
      .post<SharkeyAPI.Entity.Note>('/api/notes/show', {
        noteId: id
      })
      .then(res => ({ ...res, data: SharkeyAPI.Converter.note(res.data) }))
  }
  ...
  public async getStatusContext(
    ...
    const ancestorsPromise = this.client.post<Array<SharkeyAPI.Entity.Note>>('/api/notes/children', paramsAncestors)
    const descendantsRes = await this.client.post<Array<SharkeyAPI.Entity.Note>>('/api/notes/conversation', paramsDescendants)

    const context: Entity.Context = {
      ancestors: (await ancestorsPromise).data.map(n => SharkeyAPI.Converter.note(n)).reverse(),
      descendants: descendantsRes.data.map(n => SharkeyAPI.Converter.note(n))
    }
  ...
  public async getStatusRebloggedBy(id: string): Promise<Response<Array<Entity.Account>>> {
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/renotes', {
        noteId: id
      })
      .then(res => ({
        ...res,
        data: res.data.map(n => SharkeyAPI.Converter.user(n.user))
      }))
  }
  ...
  public async reblogStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client
      .post<SharkeyAPI.Entity.CreatedNote>('/api/notes/create', {
        renoteId: id
      })
      .then(res => ({ ...res, data: SharkeyAPI.Converter.note(res.data.createdNote) }))
  }
  ...
  /**
   * Convert a Unicode emoji or custom emoji name to a Sharkey reaction.
   * @see Sharkey's reaction-lib.ts
   */
  ...
  public async uploadMedia(file: any, _options?: { description?: string; focus?: string }): Promise<Response<Entity.Attachment>> {
    ...
    return this.client
      .post<SharkeyAPI.Entity.File>('/api/drive/files/create', formData, headers)
      .then(res => ({ ...res, data: SharkeyAPI.Converter.file(res.data) }))
  }

  public async getMedia(id: string): Promise<Response<Entity.Attachment>> {
    const res = await this.client.post<SharkeyAPI.Entity.File>('/api/drive/files/show', { fileId: id })
    return { ...res, data: SharkeyAPI.Converter.file(res.data) }
  }
  ...
  public async updateMedia(
    ...
    return this.client
      .post<SharkeyAPI.Entity.File>('/api/drive/files/update', params)
      .then(res => ({ ...res, data: SharkeyAPI.Converter.file(res.data) }))
  }
  ...
  public async votePoll(_id: string, choices: Array<number>, status_id?: string | null): Promise<Response<Entity.Poll>> {
    ...
    const res = await this.client
      ...
      .then(res => {
        const note = SharkeyAPI.Converter.note(res.data)
  ...
  public async getPublicTimeline(options?: {
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/global-timeline', params)
      .then(res => ({ ...res, data: res.data.map(n => SharkeyAPI.Converter.note(n)) }))
  }
  ...
  public async getLocalTimeline(options?: {
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/local-timeline', params)
      .then(res => ({ ...res, data: res.data.map(n => SharkeyAPI.Converter.note(n)) }))
  }
  ...
  public async getTagTimeline(
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/search-by-tag', params)
      .then(res => ({ ...res, data: res.data.map(n => SharkeyAPI.Converter.note(n)) }))
  }
  ...
  public async getHomeTimeline(options?: {
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/timeline', params)
      .then(res => ({ ...res, data: res.data.map(n => SharkeyAPI.Converter.note(n)) }))
  }
  ...
  public async getListTimeline(
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/user-list-timeline', params)
      .then(res => ({ ...res, data: res.data.map(n => SharkeyAPI.Converter.note(n)) }))
  }
  ...
  public async getConversationTimeline(options?: {
    ...
    return this.client
      .post<Array<SharkeyAPI.Entity.Note>>('/api/notes/mentions', params)
      .then(res => ({ ...res, data: res.data.map(n => SharkeyAPI.Converter.noteToConversation(n)) }))
  }
  ...
  public async getLists(): Promise<Response<Array<Entity.List>>> {
    return this.client
      .post<Array<SharkeyAPI.Entity.List>>('/api/users/lists/list')
      .then(res => ({ ...res, data: res.data.map(l => SharkeyAPI.Converter.list(l)) }))
  }
  ...
  public async getList(id: string): Promise<Response<Entity.List>> {
    return this.client
      .post<SharkeyAPI.Entity.List>('/api/users/lists/show', {
        listId: id
      })
      .then(res => ({ ...res, data: SharkeyAPI.Converter.list(res.data) }))
  }
  ...
  public async createList(title: string): Promise<Response<Entity.List>> {
    return this.client
      .post<SharkeyAPI.Entity.List>('/api/users/lists/create', {
        name: title
      })
      .then(res => ({ ...res, data: SharkeyAPI.Converter.list(res.data) }))
  }
  ...
  public async updateList(id: string, title: string): Promise<Response<Entity.List>> {
    return this.client
      .post<SharkeyAPI.Entity.List>('/api/users/lists/update', {
        listId: id,
        name: title
      })
      .then(res => ({ ...res, data: SharkeyAPI.Converter.list(res.data) }))
  ...
  public async getAccountsInList(
    ...
    const res = await this.client.post<SharkeyAPI.Entity.List>('/api/users/lists/show', {
      listId: id
    })
  ...
  public async getNotifications(options?: {
    ...
    if (options) {
      ...
      if (options.exclude_type) {
        params = Object.assign(params, {
          excludeType: options.exclude_type.map(e => SharkeyAPI.Converter.encodeNotificationType(e))
        })
      }
    }
    const res = await this.client.post<Array<SharkeyAPI.Entity.Notification>>('/api/i/notifications', params)
    const notifications: Array<Entity.Notification> = res.data.flatMap(n => {
      const notify = SharkeyAPI.Converter.notification(n)
  ...
  private async searchAccounts(
  ...
  ): Promise<Array<SharkeyAPI.Entity.UserDetail>> {
    let params = {
      query: q
    }
    if (options) {
    ...
    const res = await this.client.post<Array<SharkeyAPI.Entity.UserDetail>>('/api/users/search', params)
    return res.data
  }
  ...
  private async searchStatuses(
  ...
  ): Promise<Array<SharkeyAPI.Entity.Note>> {
    let params = {
      query: q
    }
    if (options) {
    ...
    const res = await this.client.post<Array<SharkeyAPI.Entity.Note>>('/api/notes/search', params)
    return res.data
  }
  ...
  private async searchAll(
    ...
    let accounts: Array<SharkeyAPI.Entity.UserDetail> = []
    try {
      accounts = await this.searchAccounts(q, options)
    } catch (e) {
      console.warn(e)
    }
    let statuses: Array<SharkeyAPI.Entity.Note> = []
    try {
    ...
    return {
      data: {
        accounts: accounts.map(a => SharkeyAPI.Converter.userDetail(a)),
        statuses: statuses.map(n => SharkeyAPI.Converter.note(n)),
  ...
  public async getInstance(): Promise<Response<Entity.Instance>> {
    return this.client
      .get<SharkeyAPI.Entity.Instance>('/api/v1/instance')
      .then(res => ({ ...res, data: SharkeyAPI.Converter.instance(res.data) }))
  }
  ...
  public async getInstanceTrends(_limit?: number | null): Promise<Response<Array<Entity.Tag>>> {
    return this.client
      .post<Array<SharkeyAPI.Entity.Hashtag>>('/api/hashtags/trend')
      .then(res => ({ ...res, data: res.data.map(h => SharkeyAPI.Converter.hashtag(h)) }))
  }
  ...
  public async getInstanceCustomEmojis(): Promise<Response<Array<Entity.Emoji>>> {
    return this.client
      .post<SharkeyAPI.Entity.CustomEmojiResponse>('/api/emojis')
      .then(res => ({ ...res, data: res.data.emojis.map(e => SharkeyAPI.Converter.customEmoji(e)) }))
  }
  ...
  public async getInstanceAnnouncements(): Promise<Response<Array<Entity.Announcement>>> {
    return this.client
      .post<Array<SharkeyAPI.Entity.Announcement>>('/api/announcements')
      .then(res => ({ ...res, data: res.data.map(a => SharkeyAPI.Converter.announcement(a)) }))
  }
  ...
  public async getEmojiReactions(id: string): Promise<Response<Array<Entity.Reaction>>> {
    return this.client
      .post<Array<SharkeyAPI.Entity.Reaction>>('/api/notes/reactions', {
        noteId: id
      })
      .then(res => ({
        ...res,
        data: SharkeyAPI.Converter.reactions(res.data)
      }))
  }
