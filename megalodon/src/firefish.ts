...
export default class Firefish implements MegalodonInterface {
  ...
  constructor(baseUrl: string, accessToken: string | null = null, userAgent: string | null = DEFAULT_UA, axiosInstance?: AxiosInstance) {
    ...
    this.client = new FirefishAPI.Client(baseUrl, token, agent, axiosInstance)
  ...
  public async verifyAppCredentials(): Promise<Response<Entity.Application>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support verifyAppCredentials')
      reject(err)
    })
  }
  ...
  public async refreshToken(_client_id: string, _client_secret: string, _refresh_token: string): Promise<OAuth.TokenData> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support refreshToken')
      reject(err)
    })
  }
  ...
  public async revokeToken(_client_id: string, _client_secret: string, _token: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support revokeToken')
      reject(err)
    })
  }
  ...
  public async registerAccount(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support registerAccount')
      reject(err)
    })
  }
  ...
  public async getAccountFavourites(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getAccountFavourites')
      reject(err)
    })
  }
  ...
  public async subscribeAccount(_id: string): Promise<Response<Entity.Relationship>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support subscribeAccount')
      reject(err)
    })
  }
  ...
  public async unsubscribeAccount(_id: string): Promise<Response<Entity.Relationship>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support unsubscribeAccount')
      reject(err)
    })
  }
  ...
  public async getAccountLists(_id: string): Promise<Response<Array<Entity.List>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getAccountLists')
      reject(err)
    })
  }
  ...
  public async getIdentityProof(_id: string): Promise<Response<Array<Entity.IdentityProof>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getIdentityProof')
      reject(err)
    })
  }
  ...
  public async pinAccount(_id: string): Promise<Response<Entity.Relationship>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support pinAccount')
      reject(err)
    })
  }
  ...
  public async unpinAccount(_id: string): Promise<Response<Entity.Relationship>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support unpinAccount')
      reject(err)
    })
  }
  ...
  public async setAccountNote(_id: string): Promise<Response<Entity.Relationship>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support setAccountNote')
      reject(err)
    })
  }
  ...
  public async lookupAccount(_acct: string): Promise<Response<Entity.Account>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support lookupAccount')
      reject(err)
    })
  }
  ...
  public async getBookmarks(_options?: {
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getBookmarks')
      reject(err)
    })
  }
  ...
  public async getDomainBlocks(_options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<string>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getDomainBlocks')
      reject(err)
    })
  }
  ...
  public async blockDomain(_domain: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support blockDomain')
      reject(err)
    })
  }
  ...
  public async unblockDomain(_domain: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support unblockDomain')
      reject(err)
    })
  }
  ...
  public async getFilters(): Promise<Response<Array<Entity.Filter>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getFilters')
      reject(err)
    })
  }
  ...
  public async getFilter(_id: string): Promise<Response<Entity.Filter>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getFilter')
      reject(err)
    })
  }
  ...
  public async createFilter(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support createFilter')
      reject(err)
    })
  }
  ...
  public async updateFilter(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support updateFilter')
      reject(err)
    })
  }
  ...
  public async deleteFilter(_id: string): Promise<Response<Entity.Filter>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support deleteFilter')
      reject(err)
    })
  }
  ...
  public async getEndorsements(_options?: {
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getEndorsements')
      reject(err)
    })
  }
  ...
  public async getFeaturedTags(): Promise<Response<Array<Entity.FeaturedTag>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getFeaturedTags')
      reject(err)
    })
  }
  ...
  public async createFeaturedTag(_name: string): Promise<Response<Entity.FeaturedTag>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support createFeaturedTag')
      reject(err)
    })
  }
  ...
  public async deleteFeaturedTag(_id: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support deleteFeaturedTag')
      reject(err)
    })
  }
  ...
  public async getSuggestedTags(): Promise<Response<Array<Entity.Tag>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getSuggestedTags')
      reject(err)
    })
  }
  ...
  public async getFollowedTags(): Promise<Response<Array<Entity.Tag>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getFollowedTags')
      reject(err)
    })
  }
  ...
  public async getTag(_id: string): Promise<Response<Entity.Tag>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getTag')
      reject(err)
    })
  }
  ...
  public async followTag(_id: string): Promise<Response<Entity.Tag>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support followTag')
      reject(err)
    })
  }
  ...
  public async unfollowTag(_id: string): Promise<Response<Entity.Tag>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support unfollowTag')
      reject(err)
    })
  }
  ...
  public async editStatus(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support editStatus')
      reject(err)
    })
  }
  ...
  public async getStatusSource(_id: string): Promise<Response<Entity.StatusSource>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getStatusSource')
      reject(err)
    })
  }
  ...
  public async getStatusFavouritedBy(_id: string): Promise<Response<Array<Entity.Account>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getStatusFavouritedBy')
      reject(err)
    })
  }
  ...
  public async bookmarkStatus(_id: string): Promise<Response<Entity.Status>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support bookmarkStatus')
      reject(err)
    })
  }
  ...
  public async unbookmarkStatus(_id: string): Promise<Response<Entity.Status>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support unbookmarkStatus')
      reject(err)
    })
  }
  ...
  public async muteStatus(_id: string): Promise<Response<Entity.Status>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support muteStatus')
      reject(err)
    })
  }
  ...
  public async unmuteStatus(_id: string): Promise<Response<Entity.Status>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support unmuteStatus')
      reject(err)
    })
  }
  ...
  public async getPoll(_id: string): Promise<Response<Entity.Poll>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getPoll')
      reject(err)
    })
  }
  ...
  public async getScheduledStatuses(_options?: {
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getScheduledStatuses')
      reject(err)
    })
  }
  ...
  public async getScheduledStatus(_id: string): Promise<Response<Entity.ScheduledStatus>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getScheduledStatus')
      reject(err)
    })
  }
  ...
  public async scheduleStatus(_id: string, _scheduled_at?: string | null): Promise<Response<Entity.ScheduledStatus>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support scheduleStatus')
      reject(err)
    })
  }
  ...
  public async cancelScheduledStatus(_id: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support cancelScheduledStatus')
      reject(err)
    })
  }
  ...
  public async deleteConversation(_id: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support deleteConversation')
      reject(err)
    })
  }
  ...
  public async readConversation(_id: string): Promise<Response<Entity.Conversation>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support readConversation')
      reject(err)
    })
  }
  ...
  public async getMarkers(_timeline: Array<string>): Promise<Response<Entity.Marker | Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getMarkers')
      reject(err)
    })
  }
  ...
  public async saveMarkers(_options?: {
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support saveMarkers')
      reject(err)
    })
  }
  ...
  public async getNotification(_id: string): Promise<Response<Entity.Notification>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getNotification')
      reject(err)
    })
  }
  ...
  public async dismissNotification(_id: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support dismissNotification')
      reject(err)
    })
  }
  ...
  public async readNotifications(_options: { id?: string; max_id?: string }): Promise<Response<{}>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support readNotifications')
      reject(err)
    })
  }
  ...
  public async subscribePushNotification(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support subscribePushNotification')
      reject(err)
    })
  }
  ...
  public async getPushSubscription(): Promise<Response<Entity.PushSubscription>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getPushSubscription')
      reject(err)
    })
  }
  ...
  public async updatePushSubscription(
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support updatePushSubscription')
      reject(err)
    })
  }
  ...
  public async deletePushSubscription(): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support deletePushSubscription')
      reject(err)
    })
  }
  ...
  public async getInstancePeers(): Promise<Response<Array<string>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getInstancePeers')
      reject(err)
    })
  }
  ...
  public async getInstanceActivity(): Promise<Response<Array<Entity.Activity>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getInstanceActivity')
      reject(err)
    })
  }
  ...
  public async getInstanceDirectory(_options?: {
    ...
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getInstanceDirectory')
      reject(err)
    })
  }
  ...
  public async dismissInstanceAnnouncement(_id: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support dismissInstanceAnnouncement')
      reject(err)
    })
  }
  ...
  public async addReactionToAnnouncement(_id: string, _name: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support addReactionToAnnouncement')
      reject(err)
    })
  }
  ...
  public async removeReactionFromAnnouncement(_id: string, _name: string): Promise<Response<Record<never, never>>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support removeReactionFromAnnouncement')
      reject(err)
    })
  }
  ...
  public async getEmojiReaction(_id: string, _emoji: string): Promise<Response<Entity.Reaction>> {
    return new Promise((_, reject) => {
      const err = new NotImplementedError('Firefish does not support getEmojiReaction')
      reject(err)
    })
  }
  ...
  public async tagStreaming(_tag: string): Promise<WebSocketInterface> {
    throw new NotImplementedError('Firefish does not support tagStreaming')
  }
