...
export default class Firefish implements MegalodonInterface {
    ...
    */
		return this.client
			.post<FirefishAPI.Entity.App>("/api/app/create", params)
			.then((res: Response<FirefishAPI.Entity.App>) => {
	...
	public async generateAuthUrlAndToken(
		clientSecret: string,
	): Promise<FirefishAPI.Entity.Session> {
		return this.client
	...
	public async verifyAccountCredentials(): Promise<Response<Entity.Account>> {
		return this.client
			.post<FirefishAPI.Entity.UserDetail>("/api/i")
			.then((res) => {
	...
	public async updateCredentials(options?: {
		...
		return this.client
			.post<FirefishAPI.Entity.UserDetail>("/api/i", params)
			.then((res) => {
				return Object.assign(res, {
					data: FirefishAPI.Converter.userDetail(res.data),
				});
	...
	public async getAccountStatuses(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Note>>("/api/users/notes", params)
			.then((res) => {
				const statuses: Array<Entity.Status> = res.data.map((note) =>
					FirefishAPI.Converter.note(note),
				);
				return Object.assign(res, {
					data: statuses,
				});
	...
	public async getAccountFollowers(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Follow>>("/api/users/followers", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getAccountFollowing(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Follow>>("/api/users/following", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async searchAccount(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.UserDetail>>("/api/users/search", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getFavourites(options?: {
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Favorite>>("/api/i/favorites", params)
			.then((res) => {
				return Object.assign(res, {
	...
	public async getMutes(options?: {
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Mute>>("/api/mute/list", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((mute) =>
						FirefishAPI.Converter.userDetail(mute.mutee),
					),
				});
			});
	}
	...
	public async getBlocks(options?: {
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Blocking>>("/api/blocking/list", params)
			.then((res) => {
				return Object.assign(res, {
					data: res.data.map((blocking) =>
						FirefishAPI.Converter.userDetail(blocking.blockee),
					),
				});
			});
	}
	...
	public async getFollowRequests(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.FollowRequest>>(
	...
	public async acceptFollowRequest(
		...
		await this.client.post<Record<never, never>>(
	...
	public async deleteFeaturedTag(
		_id: string,
	): Promise<Response<Record<never, never>>> {
		return new Promise((_, reject) => {
			const err = new NoImplementedError("firefish does not support");
	...
	public async getSuggestions(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.UserDetail>>(
	...
	public async postStatus(
		...
		if (options) {
			...
			if (options.visibility) {
				params = Object.assign(params, {
					visibility: FirefishAPI.Converter.encodeVisibility(
						options.visibility,
					),
				});
			}
		...
		return this.client
			...
			.then((res) => ({
				...res,
				data: FirefishAPI.Converter.note(res.data.createdNote),
			}));
	}
	...
	public async getStatusContext(
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Note>>("/api/notes/children", params)
			.then((res) => {
	...
	public async getMedia(id: string): Promise<Response<Entity.Attachment>> {
		const res = await this.client.post<FirefishAPI.Entity.File>(
	...
	public async cancelScheduledStatus(
		_id: string,
	): Promise<Response<Record<never, never>>> {
		return new Promise((_, reject) => {
			const err = new NoImplementedError("firefish does not support");
	...
	public async getPublicTimeline(options?: {
		...
		return this.client
			.post<Array<FirefishAPI.Entity.Note>>(
				"/api/notes/global-timeline",
				params,
			)
			.then((res) => ({
				...res,
				data: res.data.map((n) => FirefishAPI.Converter.note(n)),
			}));
	}
	...
	public async getConversationTimeline(options?: {
		...
		return this.client
			...
			.then((res) => ({
				...res,
				data: res.data.map((n) => FirefishAPI.Converter.noteToConversation(n)),
			}));
	}
	...
	public async getLists(): Promise<Response<Array<Entity.List>>> {
		return this.client
			...
			.then((res) => ({
				...res,
				data: res.data.map((l) => FirefishAPI.Converter.list(l)),
			}));
	}
	...
	public async getAccountsInList(
		...
		const res = await this.client.post<FirefishAPI.Entity.List>(
			...
			if (options.exclude_type) {
				params = Object.assign(params, {
					excludeType: options.exclude_type.map((e) =>
						FirefishAPI.Converter.encodeNotificationType(e),
					),
				});
			}
		}
		const res = await this.client.post<Array<FirefishAPI.Entity.Notification>>(
			"/api/i/notifications",
			params,
		);
	...
	public async dismissNotifications(): Promise<Response<Record<never, never>>> {
		return this.client.post<Record<never, never>>(
	...
	public async search(
		...
		switch (options.type) {
					...
					.then((res) => ({
						...
						data: {
							accounts: res.data.map((u) =>
								FirefishAPI.Converter.userDetail(u),
							),
							statuses: [],
							hashtags: [],
						},
			...
			case "statuses": {
				...
				return this.client
					.post<Array<FirefishAPI.Entity.Note>>("/api/notes/search", params)
					.then((res) => ({
						...res,
						data: {
							accounts: [],
	...
	public async getInstance(): Promise<Response<Entity.Instance>> {
		return this.client
			...
			.then((res) => ({
				...res,
				data: FirefishAPI.Converter.instance(res.data),
			}));
	}
	...
	public async getInstanceTrends(
		...
		return this.client
			...
			.then((res) => ({
				...res,
				data: res.data.map((h) => FirefishAPI.Converter.hashtag(h)),
			}));
	}
	...
	> {
		return this.client
			...
			.then((res) => ({
				...res,
				data: res.data.emojis.map((e) => FirefishAPI.Converter.emoji(e)),
			}));
	}
	...
	> {
		return this.client
			...
			.then((res) => ({
				...res,
				data: res.data.map((a) => FirefishAPI.Converter.announcement(a)),
			}));
	}
