...
import PixelfedAPI from './pixelfed/api_client.js'
import { MegalodonInterface, NotImplementedError, WebSocketInterface } from './megalodon.js'
import * as PixelfedOAuth from './pixelfed/oauth.js'
...
export default class Pixelfed implements MegalodonInterface {
  ...
  constructor(baseUrl: string, accessToken: string | null = null, userAgent: string | null = DEFAULT_UA, axiosInstance?: AxiosInstance) {
    ...
    this.client = new PixelfedAPI.Client(baseUrl, token, agent, axiosInstance)
  ...
  public async createApp(
    ...
    return this.client
      .post<PixelfedOAuth.AppDataFromServer>('/api/v1/apps', params)
      .then((res: Response<PixelfedOAuth.AppDataFromServer>) => PixelfedOAuth.toAppData(res.data))
  }
  ...
  public async fetchAccessToken(
    ...
    return this.client
      .post<PixelfedOAuth.TokenDataFromServer>('/oauth/token', {
        client_id,
        client_secret,
        code,
        redirect_uri,
      ...
      .then((res: Response<PixelfedOAuth.TokenDataFromServer>) => PixelfedOAuth.toTokenData(res.data))
  }
  ...
  public async registerAccount(
    ...
    return this.client.post<PixelfedAPI.Entity.Token>('/api/v1/accounts', params).then(res => {
  ...
  public async verifyAccountCredentials(): Promise<Response<Entity.Account>> {
    return this.client.get<PixelfedAPI.Entity.Account>('/api/v1/accounts/verify_credentials').then(res => {
      return Object.assign(res, {
  ...
  public async updateCredentials(options?: {
    ...
    return this.client.patch<PixelfedAPI.Entity.Account>('/api/v1/accounts/update_credentials', params).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.account(res.data)
      })
    })
  ...
  public async getAccount(id: string): Promise<Response<Entity.Account>> {
    return this.client.get<PixelfedAPI.Entity.Account>(`/api/v1/accounts/${id}`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.account(res.data)
      })
    })
  ...
  public async getAccountStatuses(
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Status>>(`/api/v1/accounts/${id}/statuses`, params).then(res => {
      return Object.assign(res, {
  ...
  public async subscribeAccount(id: string): Promise<Response<Entity.Relationship>> {
    ...
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/accounts/${id}/follow`, params).then(res => {
      return Object.assign(res, {
  ...
  private async urlToAccounts(url: string, params: Record<string, string>, get_all: boolean, sleep_ms: number) {
    const res = await this.client.get<Array<PixelfedAPI.Entity.Account>>(url, params)
    ...
    if (get_all && converted.headers.link) {
      ...
      while (parsed['next']) {
        const nextRes = await this.client.get<Array<PixelfedAPI.Entity.Account>>(parsed['next'], undefined, undefined, true)
  ...
  public async unfollowAccount(id: string): Promise<Response<Entity.Relationship>> {
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unfollow`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.relationship(res.data)
      })
    })
  ...
  public async blockAccount(id: string): Promise<Response<Entity.Relationship>> {
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/accounts/${id}/block`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.relationship(res.data)
      })
    })
  ...
  public async unblockAccount(id: string): Promise<Response<Entity.Relationship>> {
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unblock`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.relationship(res.data)
      })
    })
  ...
  public async muteAccount(id: string, notifications: boolean = true): Promise<Response<Entity.Relationship>> {
    return this.client
      .post<PixelfedAPI.Entity.Relationship>(`/api/v1/accounts/${id}/mute`, {
  ...
  public async unmuteAccount(id: string): Promise<Response<Entity.Relationship>> {
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/accounts/${id}/unmute`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.relationship(res.data)
      })
    })
  ...
  public async getRelationship(id: string): Promise<Response<Entity.Relationship>> {
    return this.client
      .get<Array<PixelfedAPI.Entity.Relationship>>('/api/v1/accounts/relationships', {
        id: [id]
      })
      .then(res => {
        return Object.assign(res, {
  ...
  public async searchAccount(
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Account>>('/api/v1/accounts/search', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(a => PixelfedAPI.Converter.account(a))
      })
    })
  ...
  public async getBookmarks(options?: {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Status>>('/api/v1/bookmarks', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(s => PixelfedAPI.Converter.status(s))
      })
    })
  ...
  public async getFavourites(options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>> {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Status>>('/api/v1/favourites', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(s => PixelfedAPI.Converter.status(s))
      })
    })
  ...
  public async getMutes(options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<Entity.Account>>> {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Account>>('/api/v1/mutes', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(a => PixelfedAPI.Converter.account(a))
      })
    })
  ...
  public async getBlocks(options?: { limit?: number; max_id?: string; min_id?: string }): Promise<Response<Array<Entity.Account>>> {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Account>>('/api/v1/blocks', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(a => PixelfedAPI.Converter.account(a))
      })
    })
  ...
  public async getFilters(): Promise<Response<Array<Entity.Filter>>> {
    return this.client.get<Array<PixelfedAPI.Entity.Filter>>('/api/v1/filters').then(res => {
      return Object.assign(res, {
  ...
  public async getFilter(id: string): Promise<Response<Entity.Filter>> {
    return this.client.get<PixelfedAPI.Entity.Filter>(`/api/v1/filters/${id}`).then(res => {
      return Object.assign(res, {
  ...
  public async createFilter(
    ...
    return this.client.post<PixelfedAPI.Entity.Filter>('/api/v1/filters', params).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.filter(res.data)
      })
    })
  ...
  public async updateFilter(
    ...
    return this.client.put<PixelfedAPI.Entity.Filter>(`/api/v1/filters/${id}`, params).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.filter(res.data)
      })
    })
  ...
  public async deleteFilter(id: string): Promise<Response<Entity.Filter>> {
    return this.client.del<PixelfedAPI.Entity.Filter>(`/api/v1/filters/${id}`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.filter(res.data)
      })
    })
  ...
  public async report(
    ...
    return this.client.post<PixelfedAPI.Entity.Report>('/api/v1/reports', params).then(res => {
      return Object.assign(res, {
  ...
  public async getFollowRequests(limit?: number): Promise<Response<Array<Entity.Account>>> {
    if (limit) {
      return this.client
        .get<Array<PixelfedAPI.Entity.Account>>('/api/v1/follow_requests', {
          limit: limit
        })
        .then(res => {
          return Object.assign(res, {
      ...
      return this.client.get<Array<PixelfedAPI.Entity.Account>>('/api/v1/follow_requests').then(res => {
        return Object.assign(res, {
          data: res.data.map(a => PixelfedAPI.Converter.account(a))
        })
      })
  ...
  public async acceptFollowRequest(id: string): Promise<Response<Entity.Relationship>> {
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/follow_requests/${id}/authorize`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.relationship(res.data)
      })
    })
  ...
  public async rejectFollowRequest(id: string): Promise<Response<Entity.Relationship>> {
    return this.client.post<PixelfedAPI.Entity.Relationship>(`/api/v1/follow_requests/${id}/reject`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.relationship(res.data)
      })
    })
  ...
  public async getEndorsements(options?: { limit?: number; max_id?: string; since_id?: string }): Promise<Response<Array<Entity.Account>>> {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Account>>('/api/v1/endorsements', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(a => PixelfedAPI.Converter.account(a))
      })
    })
  ...
  public async getPreferences(): Promise<Response<Entity.Preferences>> {
    return this.client.get<PixelfedAPI.Entity.Preferences>('/api/v1/preferences').then(res => {
      return Object.assign(res, {
  ...
  public async getFollowedTags(): Promise<Response<Array<Entity.Tag>>> {
    return this.client.get<Array<PixelfedAPI.Entity.Tag>>('/api/v1/followed_tags').then(res => {
      return Object.assign(res, {
  ...
  public async getTag(id: string): Promise<Response<Entity.Tag>> {
    return this.client.get<PixelfedAPI.Entity.Tag>(`/api/v1/tags/${id}`).then(res => {
      return Object.assign(res, {
  ...
  public async followTag(id: string): Promise<Response<Entity.Tag>> {
    return this.client.post<PixelfedAPI.Entity.Tag>(`/api/v1/tags/${id}/follow`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.tag(res.data)
      })
    })
  ...
  public async unfollowTag(id: string): Promise<Response<Entity.Tag>> {
    return this.client.post<PixelfedAPI.Entity.Tag>(`/api/v1/tags/${id}/unfollow`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.tag(res.data)
      })
    })
  ...
  public async postStatus(
    ...
    if (scheduled) {
      return this.client.post<PixelfedAPI.Entity.ScheduledStatus>('/api/v1/statuses', params).then(res => {
        return Object.assign(res, {
          data: PixelfedAPI.Converter.scheduled_status(res.data)
        })
      })
    }
    return this.client.post<PixelfedAPI.Entity.Status>('/api/v1/statuses', params).then(res => {
      return Object.assign(res, {
  ...
  public async getStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.get<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async editStatus(
    ...
    return this.client.put<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}`, params).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async deleteStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.del<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async getStatusContext(
    ...
    return this.client.get<PixelfedAPI.Entity.Context>(`/api/v1/statuses/${id}/context`, params).then(res => {
      return Object.assign(res, {
  ...
  public async getStatusRebloggedBy(id: string): Promise<Response<Array<Entity.Account>>> {
    return this.client.get<Array<PixelfedAPI.Entity.Account>>(`/api/v1/statuses/${id}/reblogged_by`).then(res => {
      return Object.assign(res, {
        data: res.data.map(a => PixelfedAPI.Converter.account(a))
      })
    })
  ...
  public async getStatusFavouritedBy(id: string): Promise<Response<Array<Entity.Account>>> {
    return this.client.get<Array<PixelfedAPI.Entity.Account>>(`/api/v1/statuses/${id}/favourited_by`).then(res => {
      return Object.assign(res, {
        data: res.data.map(a => PixelfedAPI.Converter.account(a))
      })
    })
  ...
  public async favouriteStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.post<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}/favourite`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async unfavouriteStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.post<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}/unfavourite`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async reblogStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.post<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}/reblog`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async unreblogStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.post<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}/unreblog`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async bookmarkStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.post<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}/bookmark`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async unbookmarkStatus(id: string): Promise<Response<Entity.Status>> {
    return this.client.post<PixelfedAPI.Entity.Status>(`/api/v1/statuses/${id}/unbookmark`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.status(res.data)
      })
    })
  ...
  public async uploadMedia(
    ...
    return this.client.postForm<PixelfedAPI.Entity.AsyncAttachment>('/api/v2/media', formData).then(res => {
      return Object.assign(res, {
  ...
  public async getMedia(id: string): Promise<Response<Entity.Attachment>> {
    const res = await this.client.get<PixelfedAPI.Entity.Attachment>(`/api/v1/media/${id}`)
  ...
  public async updateMedia(
    ...
    return this.client.putForm<PixelfedAPI.Entity.Attachment>(`/api/v1/media/${id}`, formData).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.attachment(res.data)
      })
    })
  ...
  public async getPoll(id: string): Promise<Response<Entity.Poll>> {
    return this.client.get<PixelfedAPI.Entity.Poll>(`/api/v1/polls/${id}`).then(res => {
      return Object.assign(res, {
  ...
  public async votePoll(id: string, choices: Array<number>): Promise<Response<Entity.Poll>> {
    return this.client
      .post<PixelfedAPI.Entity.Poll>(`/api/v1/polls/${id}/votes`, {
        choices: choices
      })
      .then(res => {
        return Object.assign(res, {
  ...
  public async getScheduledStatuses(options?: {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.ScheduledStatus>>('/api/v1/scheduled_statuses', params).then(res => {
      return Object.assign(res, {
  ...
  public async getScheduledStatus(id: string): Promise<Response<Entity.ScheduledStatus>> {
    return this.client.get<PixelfedAPI.Entity.ScheduledStatus>(`/api/v1/scheduled_statuses/${id}`).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.scheduled_status(res.data)
      })
    })
  ...
  public async scheduleStatus(id: string, scheduled_at?: string | null): Promise<Response<Entity.ScheduledStatus>> {
    ...
    return this.client.put<PixelfedAPI.Entity.ScheduledStatus>(`/api/v1/scheduled_statuses/${id}`, params).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.scheduled_status(res.data)
      })
    })
  ...
  public async getPublicTimeline(options?: {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Status>>('/api/v1/timelines/public', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(s => PixelfedAPI.Converter.status(s))
      })
    })
  ...
  public async getTagTimeline(
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Status>>(`/api/v1/timelines/tag/${hashtag}`, params).then(res => {
      return Object.assign(res, {
        data: res.data.map(s => PixelfedAPI.Converter.status(s))
      })
    })
  ...
  public async getHomeTimeline(options?: {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Status>>('/api/v1/timelines/home', params).then(res => {
      return Object.assign(res, {
        data: res.data.map(s => PixelfedAPI.Converter.status(s))
      })
    })
  ...
  public async getConversationTimeline(options?: {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Conversation>>('/api/v1/conversations', params).then(res => {
      return Object.assign(res, {
  ...
  public async readConversation(id: string): Promise<Response<Entity.Conversation>> {
    return this.client.post<PixelfedAPI.Entity.Conversation>(`/api/v1/conversations/${id}/read`).then(res => {
      return Object.assign(res, {
  ...
  public async getLists(): Promise<Response<Array<Entity.List>>> {
    return this.client.get<Record<never, never>>('/api/v1/lists').then(res => {
      return Object.assign(res, {
        data: []
      })
    })
  ...
  public async getMarkers(timeline: Array<string>): Promise<Response<Entity.Marker | Record<never, never>>> {
    return this.client
      .get<PixelfedAPI.Entity.Marker | Record<never, never>>('/api/v1/markers', {
        timeline: timeline
      })
      .then(res => {
        return Object.assign(res, {
  ...
  public async saveMarkers(options?: {
    ...
    return this.client.post<PixelfedAPI.Entity.Marker>('/api/v1/markers', params).then(res => {
      return Object.assign(res, {
        data: PixelfedAPI.Converter.marker(res.data)
      })
    })
  ...
  public async getNotifications(options?: {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Notification>>('/api/v1/notifications', params).then(res => {
      return Object.assign(res, {
  ...
  public async search(
    ...
    return this.client.get<PixelfedAPI.Entity.Results>('/api/v2/search', params).then(res => {
      return Object.assign(res, {
  ...
  public async getInstance(): Promise<Response<Entity.Instance>> {
    return this.client.get<PixelfedAPI.Entity.Instance>('/api/v1/instance').then(res => {
      return Object.assign(res, {
  ...
  public async getInstanceTrends(limit?: number | null): Promise<Response<Array<Entity.Tag>>> {
    ...
    return this.client.get<Array<PixelfedAPI.Entity.Tag>>('/api/v1/trends', params).then(res => {
      return Object.assign(res, {
  ...
  public async getInstanceCustomEmojis(): Promise<Response<Array<Entity.Emoji>>> {
    return this.client.get<Array<PixelfedAPI.Entity.Emoji>>('/api/v1/custom_emojis').then(res => {
      return Object.assign(res, {
  ...
  public async getInstanceAnnouncements(): Promise<Response<Array<Entity.Announcement>>> {
    return this.client.get<Array<PixelfedAPI.Entity.Announcement>>('/api/v1/announcements').then(res => {
      return Object.assign(res, {
